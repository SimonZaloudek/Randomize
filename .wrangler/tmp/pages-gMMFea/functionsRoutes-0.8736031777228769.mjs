...
import { onRequestGet as __api_songs_genres_js_onRequestGet } from "C:\\Users\\simon\\source\\repos\\C#\\Randomize\\functions\\api\\songs\\genres.js"
import { onRequestGet as __api_songs_random_js_onRequestGet } from "C:\\Users\\simon\\source\\repos\\C#\\Randomize\\functions\\api\\songs\\random.js"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_songs_genres_js_onRequestGet],
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_songs_random_js_onRequestGet],
    },
  {
